...
if (length ($catalogNumber) >= 1){
	...
	if ($catalogNumber =~ m/^(HSC)(\d+)J?$/){
		#delete the erroneous J in the catalog number field for the two records HSC204189 & HSC206420
