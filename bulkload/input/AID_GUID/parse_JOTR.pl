...
#fix some data quality and formatting problems that make import of fields of certain records problematic
#if (m/\"Current Determination:/){
s/\"(Current Determination:.+Groot, Sarah J\.)\t, (03\/22\/2013)\"/$1 $2/g;
#print $1.$2."\n";
#"Current Determination: Bromus madritensis ssp. rubens; Det. by: De Groot, Sarah J.	, 03/22/2013"
#}	
...
#JOTR appears not to have anything in othercatalogNumbers
